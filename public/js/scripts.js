...
$(document).ready(function() {
 ...
 // var url = new URL(window.location.href);
  var client_id = "wiqmJHyYf6k9WYYYUrNregL0ezHvWGrg";

  var client_secret ="hcJSO40TQkuOWksk";
...
function get2LegToken(onSuccess, onError) {
  ...
  var client_id = "pTfgA3QSnko7H8A0b7ceGYicVEjCKXZ6";

  var client_secret ="ysnxrLCFYFyBylq3";
  if (onSuccess) {
    MyVars.ajaxCalls.push(
      $.ajax({
        url: "/user/token",
