    ...
    success: function (res) {
     ...
     for(let r = 0; r<res.length; r++){
         ...
         console.log("VALOR EXISTE");
          ...
          for(var t=0;t<ids_buscados.length ;t++){
      ...
      viewer.addEventListener(Autodesk.Viewing.SELECTION_CHANGED_EVENT,(event)=>{
        ...
        /// viewer.setThemingColor(a[r], color, null, true);
          if(r==0){
            ...
            acumulado_ids = acumulado_ids+","+ a[r]+"";
        ...
        document.getElementById("objetos_obj").value= acumulado_ids;
            ...
            if(busqueda == false){
              ...
              //   console.log(result.name.split("["));
                  if(categoria_actual){
                    ...
                    document.getElementById("familia_obj").value = result.properties[1].displayValue;  
                    document.getElementById("nivel_obj").value = result.properties[4].displayValue;  
                    document.getElementById("nombre_elemento_obj").value = result.name;  
